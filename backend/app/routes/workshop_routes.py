...
def create_workshop():
    ...
    Returns:
        201: {workshop object}
        400: {"error": "error message", "code": "ERROR_CODE", "status": 400}
    """
    try:
        ...
        # Create workshop with TypeScript API schema
        workshop_service, _, _ = get_services()
        workshop = workshop_service.create_workshop_v2(data)
...
def list_workshops():
    ...
    Returns:
        200: [{workshop objects}]
    """
    try:
        workshop_service, _, _ = get_services()
        workshops = workshop_service.list_workshops_v2()
...
@workshop_bp.route('/api/workshops/<workshop_id>/status', methods=['PATCH'])
def update_workshop_status(workshop_id):
    ...
    Returns:
        200: {workshop object}
        400: {"error": "error message", "code": "ERROR_CODE", "status": 400}
        404: {"error": "error message", "code": "ERROR_CODE", "status": 404}
    """
    try:
        ...
        # Update workshop status and updated_at timestamp
        workshop['status'] = data['status']
        workshop['updated_at'] = datetime.utcnow().isoformat() + 'Z'
...
@workshop_bp.route('/api/workshops/<workshop_id>/signup-flag', methods=['PATCH'])
def update_workshop_signup(workshop_id):
    ...
    try:
        ...
        # Update workshop signup_enabled and updated_at timestamp
